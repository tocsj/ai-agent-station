...
CREATE TABLE `ai_agent` (
  ...
  `agent_name` varchar(50) NOT NULL COMMENT '智能体名�?,
...
VALUES
	...
	(7,'2','智能对话体（MCP�?,'自动发帖，工具服�?,'chat_stream',1,'2025-06-14 12:41:20','2025-06-14 12:41:20'),
	(8,'3','智能对话体（Auto�?,'文本调研自动分析和执行任�?,'agent',1,'2025-06-14 12:41:20','2025-08-09 10:55:46'),
	(9,'4','智能对话体（Auto�?,'ES日志文件检�?,'agent',1,'2025-06-14 12:41:20','2025-08-09 10:55:46');

/*!40000 ALTER TABLE `ai_agent` ENABLE KEYS */;
UNLOCK TABLES;


# 转储�?ai_agent_flow_config
# ------------------------------------------------------------
...
CREATE TABLE `ai_agent_flow_config` (
  ...
  `client_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '客户端名�?,
  `client_type` varchar(64) DEFAULT NULL COMMENT '客户端类�?,
  `sequence` int NOT NULL COMMENT '序列�?执行顺序)',
  `step_prompt` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '步骤提示�?,
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_agent_client_seq` (`agent_id`,`client_id`,`sequence`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='智能�?客户端关联表';
...
CREATE TABLE `ai_agent_task_schedule` (
  ...
  `cron_expression` varchar(50) NOT NULL COMMENT '时间表达�?�? 0/3 * * * * *)',
  `task_param` text COMMENT '任务入参配置(JSON格式)',
  `status` tinyint(1) DEFAULT '1' COMMENT '状�?0:无效,1:有效)',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `ai_client` (
  ...
  `client_name` varchar(50) NOT NULL COMMENT '客户端名�?,
...
VALUES
	(1,'3001','提示词优�?,'提示词优化，分为角色、动作、规则、目标等�?,1,'2025-06-14 12:34:36','2025-06-14 12:34:39'),
	...
	(9,'3004','流式对话客户�?,'流式对话客户�?,1,'2025-06-14 12:43:02','2025-06-14 12:43:02'),
	(10,'3005','地图','地图',1,'2025-06-14 12:43:02','2025-06-14 12:43:02'),
	(11,'3101','任务分析和状态判�?,'你是一个专业的任务分析师，名叫 AutoAgent Task Analyzer�?,1,'2025-06-14 12:43:02','2025-07-27 17:00:55'),
	(12,'3102','具体任务执行','你是一个精准任务执行器，名�?AutoAgent Precision Executor�?,1,'2025-06-14 12:43:02','2025-07-27 17:01:10'),
	(13,'3103','质量检查和优化','你是一个专业的质量监督员，名叫 AutoAgent Quality Supervisor�?,1,'2025-06-14 12:43:02','2025-07-27 17:01:23'),
	(14,'3104','负责响应式处�?,'你是一个智能响应助手，名叫 AutoAgent React�?,1,'2025-06-14 12:43:02','2025-08-07 14:16:47'),
	(15,'4101','任务分析和状态判�?,'你是一个专业的任务分析师，名叫 AutoAgent Task Analyzer�?,1,'2025-06-14 12:43:02','2025-07-27 17:00:55'),
	(16,'4102','具体任务执行','你是一个精准任务执行器，名�?AutoAgent Precision Executor�?,1,'2025-06-14 12:43:02','2025-07-27 17:01:10'),
	(17,'4103','质量检查和优化','你是一个专业的质量监督员，名叫 AutoAgent Quality Supervisor�?,1,'2025-06-14 12:43:02','2025-07-27 17:01:23'),
	(18,'4104','负责响应式处�?,'你是一个智能响应助手，名叫 AutoAgent React�?,1,'2025-06-14 12:43:02','2025-08-07 14:16:47');

/*!40000 ALTER TABLE `ai_client` ENABLE KEYS */;
UNLOCK TABLES;


# 转储�?ai_client_advisor
# ------------------------------------------------------------
...
CREATE TABLE `ai_client_advisor` (
  ...
  `advisor_type` varchar(50) NOT NULL COMMENT '顾问类型(PromptChatMemory/RagAnswer/SimpleLoggerAdvisor�?',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='顾问配置�?;
...
CREATE TABLE `ai_client_api` (
  ...
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '状态：0-禁用�?-启用',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_api_id` (`api_id`),
  KEY `idx_status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='OpenAI API配置�?;
...
VALUES
	(1,'1001','https://apis.itedus.cn','sk-placeholder','v1/chat/completions','v1/embeddings',1,'2025-06-14 12:33:22','2025-08-09 10:36:44');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI客户端统一关联配置�?;
...
CREATE TABLE `ai_client_model` (
  ...
  KEY `idx_status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='聊天模型配置�?;
...
CREATE TABLE `ai_client_rag_order` (
  ...
  `rag_name` varchar(50) NOT NULL COMMENT '知识库名�?,
...
VALUES
	(3,'9001','生成文章提示�?,'生成文章提示�?,1,'2025-06-14 12:44:56','2025-06-14 12:44:56');

/*!40000 ALTER TABLE `ai_client_rag_order` ENABLE KEYS */;
UNLOCK TABLES;


# 转储�?ai_client_system_prompt
# ------------------------------------------------------------
...
CREATE TABLE `ai_client_system_prompt` (
  ...
  `prompt_name` varchar(50) NOT NULL COMMENT '提示词名�?,
  `prompt_content` text NOT NULL COMMENT '提示词内�?,
  `description` varchar(1024) DEFAULT NULL COMMENT '描述',
  `status` tinyint(1) DEFAULT '1' COMMENT '状�?0:禁用,1:启用)',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
