...
public class FlowAgentMCPTest {
    ...
    public void test() {
        OpenAiChatModel chatModel = OpenAiChatModel.builder()
                .openAiApi(OpenAiApi.builder()
                        ...
                        .apiKey(System.getenv().getOrDefault("OPENAI_API_KEY", "test-api-key"))
    ...
    public McpSyncClient stdioMcpClient_Grafana() {
        ...
        env.put("GRAFANA_API_KEY", System.getenv().getOrDefault("GRAFANA_API_KEY", "test-api-key"));
    ...
    public McpSyncClient sseMcpClient_BaiduSearch() {
        String baiduApiKey = System.getenv().getOrDefault("BAIDU_MCP_API_KEY", "test-api-key");
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://appbuilder.baidu.com/v2/ai_search/mcp/")
                .sseEndpoint("sse?api_key=" + baiduApiKey)
                .build();
