...
import com.tkck.domain.agent.model.valobj.AiClientToolMcpVO;
...
public class AiClientToolMcpNode extends AbstractArmorySupport {
    ...
    private McpSyncClient createMcpSyncClient(AiClientToolMcpVO mcpVO) {
        ...
        switch (transportType){
            case "sse"->{
                ...
                if(queryParamStartIndex != -1){
                    ...
                    sseEndpoint = originalBaseUri.substring(queryParamStartIndex);
                }else{
            ...
            case "stdio"->{
                ...
                var mcpClient = McpClient.sync(new StdioClientTransport(stdioParams))
                        .requestTimeout(Duration.ofSeconds(mcpVO.getRequestTimeout())).build();
